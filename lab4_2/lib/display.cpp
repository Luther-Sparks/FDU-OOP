...
void Display::put_vertical_line(int x, int y, int l, int ch) { mvwvline(win, y, x, ch, l); }

void Display::put_horizontal_line(int x, int y, int l, int ch) { mvwhline(win, y, x, ch, l); }
